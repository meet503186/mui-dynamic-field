 ...
 */
export type Option<T extends GenericRecord = object> = {
 ...
 * @template T - The shape of the record for custom keys.
 */
export type MapValues<T extends GenericRecord = object> = {
  [key in Extract<keyof T, string> | (string & { custom?: true })]?: any;
};
 ...
 * @template T - The shape of the record for custom keys.
 */
interface BaseFieldItemConfig<T extends GenericRecord = object> {
  /**
 ...
 * @template T - The shape of the record for custom keys.
 */
export type FieldItemConfig<T extends GenericRecord = object> =
  ...
  | (BaseFieldItemConfig<T> & {
      ...
      extraProps?: Partial<TextFieldProps> & {
         ...
         */
        countryCodes?: Option[];
        countryCodeFieldProps?: Partial<AutoCompleteFieldProps>;
      };
    })
  | (BaseFieldItemConfig<T> & {
      /**
 ...
 * @template T - The shape of the record for custom keys.
 */
export interface FieldChangeProps<T extends GenericRecord = object> {
  /**
 ...
 * @template T - The shape of the record for custom keys.
 */
export type DropDownState<T extends GenericRecord = object> = {
